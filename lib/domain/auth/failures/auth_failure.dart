...
// Re-export core AuthFailure
export 'package:agricola_core/src/domain/auth_failure.dart';

/// Firebase-specific factory for AuthFailure
AuthFailure authFailureFromFirebaseException(FirebaseAuthException e) {
  switch (e.code) {
    case 'user-not-found':
